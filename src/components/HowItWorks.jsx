    ...
    return (
        <section className="bg-gradient-to-br text-slate-900 p-4 md:p-8 pb-16">
            ...
            <div className="flex flex-wrap gap-4 justify-center container mx-auto mt-8">
                {
                    images.map(image => <img src={image} alt="Image" width="500px" height="700px" key={image} className="lg:hover:scale-150 w-full md:w-48 select-none transition-all rounded-3xl border-8 border-spacing-8 border-slate-900 shadow-lg"/>)
                }
            </div>
        </section>
    );
